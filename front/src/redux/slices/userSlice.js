...
const fetchUser = async (params) => {
    ...
    const {data} = await instance.get('https://react-eshop-9tge.onrender.com/api/users/current')
    return data.user
}

export const registerUser = createAsyncThunk('items/registerUser', async (params) => {
    console.log(params)
    await axios.post(`https://react-eshop-9tge.onrender.com/api/users/auth/register`, params)
})
...
export const loginUser = createAsyncThunk('items/loginUser', async (params) => {
    let {data} = await axios.post(`https://react-eshop-9tge.onrender.com/api/users/auth/login`, params)
...
export const editProfile = createAsyncThunk('items/editProfile', async (params) => {
    ...
    let {data} = await axios.patch(`https://react-eshop-9tge.onrender.com/api/users/current`, params,{headers} )
