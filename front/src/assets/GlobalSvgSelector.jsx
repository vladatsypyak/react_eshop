            ...
            return (
                ...
                <svg width="42" height="40" viewBox="0 0 42 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" clipRule="evenodd"
                          d="M35.7 21.9048H29.4C25.9203 21.9048 23.1 24.4629 23.1 27.6191V33.3333C23.1 36.4895 25.9203 39.0476 29.4 39.0476H35.7C39.1797 39.0476 42 36.4895 42 33.3333V27.6191C42 24.4629 39.1797 21.9048 35.7 21.9048ZM12.6 21.9048H6.3C2.8203 21.9048 0 24.4629 0 27.6191V33.3333C0 36.4895 2.8203 39.0476 6.3 39.0476H12.6C16.0797 39.0476 18.9 36.4895 18.9 33.3333V27.6191C18.9 24.4629 16.0797 21.9048 12.6 21.9048ZM35.7 0.952393H29.4C25.9203 0.952393 23.1 3.51049 23.1 6.66668V12.381C23.1 15.5372 25.9203 18.0952 29.4 18.0952H35.7C39.1797 18.0952 42 15.5372 42 12.381V6.66668C42 3.51049 39.1797 0.952393 35.7 0.952393ZM18.9 6.66668V12.381C18.9 15.5372 16.0797 18.0952 12.6 18.0952H6.3C2.8203 18.0952 0 15.5372 0 12.381V6.66668C0 3.51049 2.8203 0.952393 6.3 0.952393H12.6C16.0797 0.952393 18.9 3.51049 18.9 6.66668Z"
                          fill="white"/>
                </svg>

            )
        case "like_not_active" :
            return (
                ...
                <svg width="25" height="26" viewBox="0 0 25 26" fill="none" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <defs>
                        <pattern id="pattern0" patternContentUnits="objectBoundingBox" width="1" height="1">
                            <use xlinkHref="#image0_15_180" transform="matrix(0.0208 0 0 0.02 -0.02 0)"/>
                        </pattern>
                        <image id="image0_15_180" width="50" height="50"
                               xlinkHref="data:image/png;base64,"/>
                    </defs>
                </svg>
            )
        case "heart_icon" :
                ...
                <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                    <g data-name="Layer 2">
                        <path d="M31 16A15 15 0 1 1 16 1a15 15 0 0 1 15 15ZM3 16A13 13 0 1 0 16 3 13 13 0 0 0 3 16Z"
                              fill="#ffffff" className="fill-000000"></path>
                        <path
                            d="M19.87 10.41 14.29 16l5.58 5.59a1 1 0 0 1 0 1.41 1 1 0 0 1-1.41 0l-6.36-6.36a.91.91 0 0 1 0-1.28L18.46 9a1 1 0 0 1 1.41 0 1 1 0 0 1 0 1.41Z"
                            fill="#ffffff" className="fill-000000"></path>
                    </g>
                </svg>
